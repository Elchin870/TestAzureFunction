...
namespace TestAzureFunction
{
    public class Function1
    {
        ...
        public IActionResult Run([HttpTrigger(AuthorizationLevel.Admin, "get", "post")] HttpRequest req)
        {
            ...
            return new OkObjectResult("Welcome Developers!(Admin)");
        }
        ...
        {
            _logger.LogInformation("C# HTTP trigger function processed a request.");
            return new OkObjectResult("Welcome Developers!(Function)");
        }
        ...
        {
            _logger.LogInformation("C# HTTP trigger function processed a request.");
            return new OkObjectResult("Welcome Developers!(Anonymous)");
        }
    }
}
